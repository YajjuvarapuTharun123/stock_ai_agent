...
def get_stock_data():
    ...
    try:
        ...
        # Create stock plot (3D)
        stock_plot = create_stock_plot(stock_data)
        ...
        # Modify the stock_plot HTML to include an <img> tag with the base64 image
        stock_plot_html = f'<img src="data:image/png;base64,{stock_plot}" alt="Stock Price Plot">'

        return jsonify({
            "stock_data": stock_data.to_dict(),
            "analysis": analysis_text,
            "stock_plot": stock_plot_html,
